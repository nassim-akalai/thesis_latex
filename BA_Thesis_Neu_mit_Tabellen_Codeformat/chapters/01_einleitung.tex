...
\item \textbf{IoT-Stack}: Die Benchmark-Konfiguration erweitert die Minimal-Konfiguration um OpenThread, CoAP und DTLS/ PSK. Firmware-Updates {\"u}ber MCUmgr und MCUboot werden davon getrennt in der Demonstrationsanwendung \lstinline[style=codeinline]|iot_sensor| untersucht.
\end{itemize}
